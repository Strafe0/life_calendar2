...
mixin _$Event {
 ...
 String get id; String get title;@DateConverter() DateTime get date;
...
@useResult
$Res call({
 String id, String title,@DateConverter() DateTime date
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String title, @DateConverter()  DateTime date)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Event() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  String title, @DateConverter()  DateTime date)  $default,) {final _that = this;
switch (_that) {
case _Event():
return $default(_that.id,_that.title,_that.date);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id,  String title, @DateConverter()  DateTime date)?  $default,) {final _that = this;
switch (_that) {
case _Event() when $default != null:
return $default(_that.id,_that.title,_that.date);case _:
  return null;
...
class _Event implements Event {
  const _Event({required this.id, required this.title, @DateConverter() required this.date});
